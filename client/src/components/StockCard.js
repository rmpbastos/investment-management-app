...
//         console.log(`Fetched sentiment for ${ticker}:`);
//         console.log(`Overall Sentiment Score: ${overallSentimentScore}`);
//         console.log(`Ticker Sentiment Score: ${tickerSentimentScore}`);
...
//       console.log(`Sending prediction request for ${ticker}:`, predictionPayload);
