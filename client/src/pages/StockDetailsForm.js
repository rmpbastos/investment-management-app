...
const StockDetailsForm = () => {
  ...
  // Function to add stock details to portfolio and update total wealth
  // const handleSubmit = async (e) => {
  //   e.preventDefault();
  //   const stockDetails = {
  //     userId,
  ...
  //     // await axios.post("/api/total-wealth/update", { userId });
  //     // console.log("Total wealth updated successfully.");
